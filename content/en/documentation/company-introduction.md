...
aliases:
  - /documentation/company-philosophy/
---
...
Privacy.Fish is designed to avoid keeping data whenever possible: no unnecessary logs, no analytics, no tracking, and no permanent server-side mailbox.

The code is open source, the infrastructure is hosted in Norway, accounts are created through a private payment flow, and the system is built so privacy and security come before convenience.

## What You Should Know Before Signing Up

Privacy.Fish works differently from traditional email providers.

You use the Privacy.Fish app with your normal email client, mail is stored on your own devices, server-side mail is deleted after 14 days or when you delete it, and iPhone is not currently supported.

## How Email / SMTP Works

Before we dive into the following topics, it is important to understand how sending and receiving an email works - and what Privacy.Fish does better than others.
