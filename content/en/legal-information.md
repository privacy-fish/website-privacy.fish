...
description: "Legal and contact information for privacy.fish."
eyebrow: "Legal"
show_meta: false
show_cta: false
---

privacy.fish is a privacy-first email service built to minimize retained data, attack surface, and trust.
...
privacy.fish servers are located in Norwegian data centers. The service is designed around the legal obligations that apply in Norway while retaining as little useful data as possible.

We disclose only the minimum data legally required and challenge overbroad requests where legally possible.
