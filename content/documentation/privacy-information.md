...
Submit the temporary payment code, cryptocurrency used, and the transaction hash through the [crypto payment confirmation form](https://github.com/signup/crypto-confirmation-form "crypto payment confirmation form"). Do not attempt to send us your username, email address, real name, or other identifying information.
